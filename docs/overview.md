...
- `teammate-parallel-research`: MCP（Arxiv・WebSearch・DeepWiki）を使った多軸リサーチ
...
HTTP ベース: aws-docs（AWS ドキュメント）、deepwiki（GitHub リポジトリ AI ドキュメント）、grep-github（100万以上のパブリックリポジトリ検索）
