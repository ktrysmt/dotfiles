...
brew update
brew install peco yarn lua wget tmux peco git zsh nkf tree ripgrep reattach-to-user-namespace fd fzf tig fzy exa python2 python3 rbenv goenv direnv jid
